...
if (isset($_POST['clashconfig']) && !empty($_POST['clashconfig'])) {
                ...
                <div class="mb-4">
                    <div class="col input-group">
                        <select class="form-select form-select-lg" name="clashconfig" aria-label="themex">
                            <?php foreach ($arrFiles as $file) echo "<option value=\"".$file."\"".(($file===$selected_config)?' selected':'').">".$file."</option>"; ?>
                        </select>
                    </div>
                </div>
                <div class="d-grid">
                            ...
                            <form action="configs.php" method="post">
                                ...
                                ><?php
                                    if ($core_mode == 'singbox') {
                                        ...
                                        if (file_exists($config_file)) echo trim(file_get_contents($config_file));
                                    } else {
                                        if (isset($selected_config) && file_exists($selected_config)) {
