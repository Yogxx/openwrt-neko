...
if(isset($_POST['tcp_mode']) || isset($_POST['udp_mode'])){
    ...
    if(in_array($new_tcp, $allowed_tcp)){
        shell_exec("uci set neko.cfg.tcp_mode='$new_tcp' && uci commit neko");
        $tcp_mode = $new_tcp;
    }
    if(in_array($new_udp, $allowed_udp)){
        shell_exec("uci set neko.cfg.udp_mode='$new_udp' && uci commit neko");
        $udp_mode = $new_udp;
    }
            ...
            <table class="table table-borderless mb-3">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-9">
                            <div class="form-control text-center" id="mihomover">Loading...</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="col-9">
                            <div class="form-control text-center" id="singboxver">Loading...</div>
                        </td>
                    </tr>
