...
$neko_cfg['port']=exec("grep '^port:' $selected_config | awk '{print $2}'");
...
$neko_cfg['enhanced']=strtoupper(exec("cat $selected_config | grep enhanced-mode | awk '{print $2}'"));
$neko_cfg['secret']=exec("cat $selected_config | grep secret | awk '{print $2}'");
$neko_cfg['ext_controller'] = exec("awk -F': ' '/^external-controller:/{print $2}' $selected_config | tr -d '\"'");
