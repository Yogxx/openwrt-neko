    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info">
                ...
                Core <?php echo strtoupper($current_core); ?> is currently running. 
                Please stop the service first to change the core.
            </div>
            <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const mihomoVerEl = document.getElementById('mihomover');
    const singboxVerEl = document.getElementById('singboxver');

    fetch('./lib/version.php')
        .then(response => response.json())
        .then(data => {
            cliverElement.textContent = data.neko.current || '-';
            mihomoVerEl.textContent = data.mihomo || '-';
            singboxVerEl.textContent = data.singbox || '-';
        })
        .catch(() => {
            cliverElement.textContent = 'Failed to load';
            mihomoVerEl.textContent = '-';
            singboxVerEl.textContent = '-';
        });
});
</script>
